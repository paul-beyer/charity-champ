...
class CalculationServiceSpec extends UnitSpec{
    ...
    def "calling sumActivities should return 30 with 3 activities of 10 a piece"(){
		...
		def total = calcService.sumActivities(activities)
	...
	def "calling sumJeanPayments with a wide range of positive numbers"(){
		...
		when:
		def jeanPayments = []
		def jeanPayment1 = new JeansPayment(employeeUserId: 'beyerp', payerFirstName : 'Paul', payerLastName: 'Beyer', amtPaid : new BigDecimal('10.43'), donationDate : donationDate.toDate()).save()
		jeanPayments << jeanPayment1
		def jeanPayment2 = new JeansPayment(employeeUserId: 'beyerp', payerFirstName : 'Paul', payerLastName: 'Beyer', amtPaid : new BigDecimal('189.56'), donationDate : donationDate.toDate()).save()
		jeanPayments << jeanPayment2
		def jeanPayment3 = new JeansPayment(employeeUserId: 'beyerp', payerFirstName : 'Paul', payerLastName: 'Beyer', amtPaid : new BigDecimal('46.87'), donationDate : donationDate.toDate()).save()
		jeanPayments << jeanPayment3
		def jeanPayment4 = new JeansPayment(employeeUserId: 'beyerp', payerFirstName : 'Paul', payerLastName: 'Beyer', amtPaid : new BigDecimal('145.01'), donationDate : donationDate.toDate()).save()
		jeanPayments << jeanPayment4
		def jeanPayment5 = new JeansPayment(employeeUserId: 'beyerp', payerFirstName : 'Paul', payerLastName: 'Beyer', amtPaid : new BigDecimal('344.00'), donationDate : donationDate.toDate()).save()
		jeanPayments << jeanPayment5
		def jeanPayment6 = new JeansPayment(employeeUserId: 'beyerp', payerFirstName : 'Paul', payerLastName: 'Beyer', amtPaid : new BigDecimal('99'), donationDate : donationDate.toDate()).save()
		jeanPayments << jeanPayment6
		
		def total = calcService.sumJeanPayments(jeanPayments)
