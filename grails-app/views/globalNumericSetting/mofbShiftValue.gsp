		...
		<div class="manageChampRightPanel">
				<div class="nav" role="navigation">
					<ul>
						...
						<li><g:link class="create" action="createMofbShiftValue"><g:message code="default.new.label" args="['MOFB Shift Type']" /></g:link></li>
					</ul>
				</div>
					...
					<table>
						...
						<g:each in="${globalNumericSettingInstanceList}" status="i" var="globalNumericSettingInstance">
							<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
								...
								<td><g:link action="showMofbShiftValue" id="${globalNumericSettingInstance.id}">${fieldValue(bean: globalNumericSettingInstance, field: "name")}</g:link></td>
