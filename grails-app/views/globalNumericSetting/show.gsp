...
<html>
	...
	<body>
		<a href="#show-globalNumericSetting" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-globalNumericSetting" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${globalNumericSettingInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
