		...
		<div class="manageChampRightPanel">
				<div class="nav" role="navigation">
					<ul>
						...
						<li><g:link class="create" action="createMealADollarBuys"><g:message code="default.new.label" args="['Meals a Dollar Buys']" /></g:link></li>
					</ul>
				</div>
					...
					<table>
						...
						<g:each in="${globalNumericSettingInstanceList}" status="i" var="globalNumericSettingInstance">
							<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
								...
								<td><g:link action="showMealsDollarBuys" id="${globalNumericSettingInstance.id}">${fieldValue(bean: globalNumericSettingInstance, field: "name")}</g:link></td>
