...
<html>
	...
	<body>
		<a href="#edit-jeansPayment" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-jeansPayment" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${jeansPaymentInstance?.version}" />
				<fieldset class="form">
