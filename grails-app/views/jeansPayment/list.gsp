...
<html>
	...
	<body>
		<a href="#list-jeansPayment" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-jeansPayment" class="content scaffold-list" role="main">
			...
			<table>
				...
				<tbody>
				<g:each in="${jeansPaymentInstanceList}" status="i" var="jeansPaymentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${jeansPaymentInstance.id}">${fieldValue(bean: jeansPaymentInstance, field: "employeeUserId")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${jeansPaymentInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
