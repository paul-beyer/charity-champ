...
<html>
	...
	<body>
		<a href="#edit-volunteerShift" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-volunteerShift" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${volunteerShiftInstance?.version}" />
				<fieldset class="form">
